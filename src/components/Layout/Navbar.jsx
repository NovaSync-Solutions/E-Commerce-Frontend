...
function Navbar() {
  ...
  return (
    <header className="flex items-center w-full px-36  m-auto text-black bg-slate-100 h-24 overflow-hidden">
      <nav className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-3 bg-gray-200 border border-gray-300 py-2 px-3 rounded-md">
        ...
        <div className="flex  gap-3 jus items-center text-slate-600 text-2xl">
